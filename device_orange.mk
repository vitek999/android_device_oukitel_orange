...
$(call inherit-product-if-exists, vendor/oukitel/orange/orange-vendor.mk)
...
ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/oukitel/orange/prebuilt/Image.gz-dtb
else
...
PRODUCT_COPY_FILES += \
    ...
    device/oukitel/orange/rootdir/init.target.rc:root/init.target.rc \
    ...
    device/oukitel/orange/rootdir/init.usb.rc:root/init.usb.rc \
    device/oukitel/orange/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
    device/oukitel/orange/rootdir/init.aee.rc:root/init.aee.rc \
    ...
    device/oukitel/orange/rootdir/fstab.swap:root/fstab.swap \
    device/oukitel/orange/rootdir/ueventd.rc:root/ueventd.rc \
    device/oukitel/orange/etc/media_codecs.xml:system/etc/media_codecs.xml \
    device/oukitel/orange/etc/init/audioserver.rc:system/etc/init/audioserver.rc \
    device/oukitel/orange/etc/init/mediacodec.rc:system/etc/init/mediacodec.rc \
    device/oukitel/orange/etc/init/cameraserver.rc:system/etc/init/cameraserver.rc \
    device/oukitel/orange/etc/init/rild.rc:system/etc/init/rild.rc \
    device/oukitel/orange/media_profiles.xml:system/etc/media_profiles.xml \
...
# BT A2DP
PRODUCT_COPY_FILES += \
    vendor/oukitel/orange/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
